...
const IconInfoBar = () => {
  return (
    <div id="icon-info-bar">
      <div className="icon-info-card" id="card001">
      ...
      <div className="icon-info-card" id="card002">
        <div className="icon-card-image">
      ...
      <div className="icon-info-card" id="card003">
        <div className="icon-card-image">
      ...
      <div className="icon-info-card" id="card004">
        <div className="icon-card-image">
